  ...
  _createClass(ServiceWorkerPlugin, [{
    ...
    value: function apply(compiler) {
      ...
      if (_path2.default.resolve(filename) === _path2.default.normalize(filename)) {
        this.options.filename = _path2.default.relative(compiler.options.output.path, filename);
      }
      ...
      compiler.plugin('normal-module-factory', function (nmf) {
        nmf.plugin('after-resolve', function (result, callback) {
          ...
          if (result.resource === runtimePath) {
            var data = {
              scriptURL: _path2.default.join(_this.options.publicFilePath)
            };
    ...
    value: function handleEmit(compilation, compiler, callback) {
      ...
      var minify = compiler.options.optimization && compiler.options.optimization.minimize;
